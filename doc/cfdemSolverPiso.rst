...
"cfdemSolverPiso" is a coupled CFD-DEM solver using CFDEMcoupling, an open-source parallel coupled CFD-DEM framework. Based on pisoFoam\ |reg|\ (*), a finite
...
For more details, see :ref:`Goniva et al. (2010) <Goniva2010>`.
