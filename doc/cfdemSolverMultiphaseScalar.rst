...
"cfdemSolverMultiphaseScalar" is a coupled CFD-DEM solver using the CFDEMcoupling framework.
...
DEM code LIGGGHTS for solid particles. Additionally, it enable evaluation of
temperature and dissolved species concentration fields.
